...
if( !empty($_POST['btn_submit']) ) {
	...
	if( empty($error_message) ) {
        ...
        try {
            ...
            // SQL作成
            $stmt = $pdo->prepare("INSERT INTO message3 (view_name, message, post_date) VALUES ( :view_name, :message, :current_date)");
		...
		header('Location:http://localhost/bullitenBoard/home3.php/');
		exit;
	}
}
...
if( !empty($pdo) ) {
    ...
    // メッセージのデータを取得する
    $sql = "SELECT view_name,message,post_date FROM message3 ORDER BY post_date DESC";
...
<body>
<h1><font color="black">相談掲示板(課外活動)</h1>
